...
function getPathState(path, activeChapter) {
  ...
  return path.from === activeChapter || path.to === activeChapter
    ? "active"
    : "dimmed";
}

export default function EldoriaWorldMap({
  currentSlug,
  entries,
  onEnterChronicle
}) {
  ...
  const activeChapter =
    hoveredChapter || focusedChapter || selectedChapter || "";
  ...
  function updateZoom(nextZoom) {
    ...
    setPan((currentPan) =>
      clampPan(
        clampedZoom <= 1 ? { x: 0, y: 0 } : currentPan,
        clampedZoom,
        rect.width,
        rect.height
      )
        ...
        >
          ...
          >
            ...
            <g className="eldoria-map-sea">
              ...
              <path
                className="eldoria-map-current"
                d="M28 120 C150 84, 270 94, 366 146"
              />
              <path
                className="eldoria-map-current"
                d="M744 102 C850 98, 926 130, 980 210"
              />
              <path
                className="eldoria-map-current"
                d="M36 584 C170 536, 286 548, 382 620"
              />
              <path
                className="eldoria-map-current subtle"
                d="M760 538 C866 498, 944 510, 992 592"
              />

              <path className="eldoria-map-coastal-glow" d={COAST_PATH} />
              <path
                className="eldoria-map-coast-wave"
                d="M674 90 C786 108, 864 144, 914 206"
              />
              <path
                className="eldoria-map-coast-wave"
                d="M804 442 C856 474, 890 512, 910 566"
              />
              <path
                className="eldoria-map-coast-wave subtle"
                d="M110 564 C226 600, 360 610, 516 592"
              />
              <path
                className="eldoria-map-coast-wave"
                d="M642 116 C756 130, 836 164, 892 224"
              />
              <path
                className="eldoria-map-coast-wave"
                d="M770 470 C824 500, 860 540, 882 594"
              />
              <path
                className="eldoria-map-coast-wave subtle"
                d="M136 534 C248 566, 374 576, 516 562"
              />
              <path
                className="eldoria-map-coast-wave subtle"
                d="M130 148 C262 110, 434 98, 612 118 C748 134, 842 168, 906 244"
              />
              <path
                className="eldoria-map-coast-wave subtle"
                d="M730 612 C798 574, 854 560, 920 570"
              />
              <path
                className="eldoria-map-coast-wave subtle"
                d="M62 188 C146 156, 236 144, 344 160"
              />
              <path
                className="eldoria-map-coast-wave subtle"
                d="M856 430 C916 462, 954 512, 972 574"
              />
            </g>

            <g className="eldoria-map-landmass">
              <path
                className="eldoria-map-peninsula-shadow"
                d={LAND_PATH}
              ...
              <path
                className="eldoria-map-coastline-highlight"
                d={COAST_HIGHLIGHT_PATH}
              />
            </g>

            <g className="eldoria-map-atmosphere-layer">
              <ellipse
                className="eldoria-map-capital-bloom"
                cx="792"
                cy="278"
                rx="184"
                ry="160"
              />
              <ellipse
                className="eldoria-map-capital-aura"
                cx="764"
                cy="300"
                rx="242"
                ry="184"
              />
              <ellipse
                className="eldoria-map-echo-mist"
                cx="498"
                cy="136"
                rx="150"
                ry="98"
              />
              <ellipse
                className="eldoria-map-echo-grove-biome"
                cx="456"
                cy="164"
                rx="178"
                ry="124"
              />
              <ellipse
                className="eldoria-map-capital-biome"
                cx="730"
                cy="294"
                rx="246"
                ry="184"
              />
              <ellipse
                className="eldoria-map-warfront-gloom"
                cx="632"
                cy="552"
                rx="166"
                ry="124"
            ...
            <g className="eldoria-map-artifact-layer">
              <rect
                className="eldoria-map-paper-grain"
                height={VIEW_BOX.height}
                rx="28"
                width={VIEW_BOX.width}
                x="0"
              ...
              />
              <rect
                className="eldoria-map-vignette"
                height={VIEW_BOX.height}
                rx="28"
                width={VIEW_BOX.width}
                x="0"
            ...
            <g className="eldoria-map-terrain">
              <path
                className="eldoria-map-contour"
                d="M198 132 C320 112, 446 110, 590 118 C704 124, 790 146, 850 192"
              />
              <path
                className="eldoria-map-contour"
                d="M184 286 C300 252, 410 242, 558 254 C682 264, 782 256, 860 226"
              />
              <path
                className="eldoria-map-contour"
                d="M186 574 C304 546, 424 546, 556 580 C644 602, 718 600, 786 570"
              />
              <path
                className="eldoria-map-contour subtle"
                d="M238 206 C350 194, 470 202, 612 226 C708 242, 788 240, 846 220"
              />
              <path
                className="eldoria-map-contour subtle"
                d="M242 454 C332 432, 432 428, 546 444 C642 458, 722 458, 784 438"
              />
              <path
                className="eldoria-map-river"
                d="M338 166 C372 226, 378 298, 364 372 C352 434, 362 494, 412 574"
              />
              <path
                className="eldoria-map-river branch"
                d="M364 374 C430 348, 494 304, 580 236"
              />
              <path
                className="eldoria-map-road"
                d="M232 420 C332 344, 456 224, 500 130"
              />
              <path
                className="eldoria-map-road secondary"
                d="M500 130 C612 156, 700 206, 780 280"
              />
              <path
                className="eldoria-map-road secondary"
                d="M780 280 C720 376, 648 468, 590 538"
              />
            </g>
            ...
            <g className="eldoria-map-chronicle-arc-layer">
              ...
              {entries.map((node) => (
                ...
                >
                  <circle
                    className="eldoria-map-chronicle-dot"
                    cx={node.svgX}
                    cy={node.svgY}
                    r="3.6"
                  />
                  <text
                    className="eldoria-map-chronicle-label"
                    x={node.svgX}
                    y={node.svgY - 22}
                  >
                    {node.meta?.chapterNumeral ||
                      node.chapterLabel.replace("Chapter ", "")}
                  </text>
                </g>
              ))}
            </g>
            ...
            <g className="eldoria-map-story-paths">
              ...
              {Object.entries(POWER_PATHS).map(([key, d]) => (
                <path
                  className="eldoria-map-power-path"
                  d={d}
                  key={`power-${key}`}
                />
              ))}
            ...
            <g className="eldoria-map-node-layer">
              {entries.map((node) => {
                ...
                const isFocused =
                  activeNode?.chapterNumber === node.chapterNumber;
                const scale =
                  isCurrent && isFocused
                    ? 1.12
                    : isCurrent
                ...
                return (
                  ...
                  >
                    ...
                    {node.chapterNumber === "1" ? (
                      <circle
                        className="eldoria-map-node-fracture-ring"
                        cx="0"
                        cy="0"
                        r="30"
                      />
                    ...
                    {node.chapterNumber === "2" ? (
                      <>
                        <circle
                          className="eldoria-map-node-echo-ring"
                          cx="0"
                          cy="0"
                          r="27"
                        />
                        <ellipse
                          className="eldoria-map-node-echo-ring subtle"
                          cx="1"
                          cy="-1"
                          rx="35"
                          ry="37"
                    ...
                    {node.chapterNumber === "4" ? (
                      <>
                        <path
                          className="eldoria-map-node-war-arc"
                          d="M-30 10 C-26 -22, 2 -34, 30 -24"
                        />
                        <path
                          className="eldoria-map-node-war-arc broken"
                          d="M22 -12 C38 0, 42 20, 34 38"
                        />
                      </>
                    ) : null}

                    <circle
                      className="eldoria-map-svg-node-ring"
                      fill="none"
                      r={radii.ring}
                    />
                    <circle
                      className="eldoria-map-svg-node-core"
                      r={radii.core}
                    />

                    {node.chapterNumber === "1" ? (
                      <path
                        className="eldoria-map-node-motif eldoria-map-node-motif-fracture"
                        d="M-9 -18 L-3 -5 L-8 2 L3 13 L9 20"
                      />
                    ) : null}

                    {node.chapterNumber === "2" ? (
                      <path
                        className="eldoria-map-node-motif eldoria-map-node-motif-echo"
                        d="M-18 -4 C-10 -18, 10 -18, 18 -4 M-14 2 C-8 -8, 8 -8, 14 2"
                      />
                    ) : null}

                    {node.chapterNumber === "3" ? (
                      <path
                        className="eldoria-map-node-motif eldoria-map-node-motif-capital"
                        d="M-10 8 L-10 -4 L0 -13 L10 -4 L10 8 M-6 8 L-6 0 L6 0 L6 8"
                      />
                    ) : null}

                    {node.chapterNumber === "4" ? (
                      <path
                        className="eldoria-map-node-motif eldoria-map-node-motif-warfront"
                        d="M-13 12 C-7 -4, -2 -10, 3 -18 M1 -16 C10 -6, 13 2, 14 12"
                      />
                    ) : null}
          ...
          {activeNode ? (
            ...
            >
              ...
              <p className="eldoria-map-tooltip-subtitle">
                {activeNode.subtitle}
              </p>
              <p className="eldoria-map-tooltip-state">{activeNode.mapTitle}</p>
              <p className="eldoria-map-tooltip-emotion">
                {activeNode.emotionalState}
              </p>
              <p className="eldoria-map-tooltip-action">
                {activeNode.slug ? "Enter Chronicle" : "Sealed"}
              </p>
            </div>
          ) : null}
        </div>
