...
const CURATION_MAP = [
  {
    ...
    set: {
      ...
      versionFamily: "between-two-worlds"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "echoes-of-aeloria"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "queen-of-borrowed-crowns"
    }
  },
  {
  ...
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "we-were-never-meant-to-survive"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "the-one-you-used-to-be"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "you-were-better-before-you-saved-the-world"
    }
  },
  {
    ...
    set: {
      ...
      versionFamily: "what-the-world-made-of-me"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "the-cost-i-couldnt-pay"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "this-is-my-light"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "heart-full-of-hope"
    }
  },
  {
  ...
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "holding-my-heart-back"
    }
  },
  {
  ...
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "the-girl-i-couldnt-kill"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "blooming-forward"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "i-am-more-than-what-they-see"
    }
  },
  {
  ...
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "maybe-someday-baby"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "porch-light-fading"
    }
  },
  {
  ...
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "hidden-identity-ballad"
    }
  },
  {
  ...
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "between-the-name-and-the-mirror"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "what-i-dont-say-out-loud"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "quiet-kept-me-alive"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "the-girl-in-the-quiet"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "rooms-with-no-windows"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "angel-made-of-quiet-fire"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "you-wanted-a-hero"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "the-hands-that-shield"
    }
  },
  {
  ...
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: true,
      versionFamily: "last-light-of-the-faithful"
    }
  },
  {
    ...
    set: {
      ...
      isArchive: false,
      isHomepageEligible: false,
      versionFamily: "necessary-damage"
    }
  },
  {
...
function buildPostKeys(post) {
  ...
  return {
    ...
    normalizedComposite: normalizeText(
...
function chooseLeader(candidates, familyKey, matchTitle) {
  ...
  const rankedCandidates = (exactMatches.length ? exactMatches : candidates)
    .slice()
    .sort((left, right) => {
      ...
      const leftSlugScore =
        leftSlug === familyKey
          ? 2
          : leftSlug.startsWith(`${familyKey}-`)
            ? 1
            : 0;
      const rightSlugScore =
        rightSlug === familyKey
          ? 2
          : rightSlug.startsWith(`${familyKey}-`)
            ? 1
            : 0;
      ...
      const leftOriginalScore = leftVersion.includes("original version")
        ? 2
        : leftVersion === ""
          ? 1
          : 0;
      const rightOriginalScore = rightVersion.includes("original version")
        ? 2
        : rightVersion === ""
          ? 1
          : 0;
...
function updatePost(post, updates) {
  return {
    ...post,
    isPrimaryVersion:
      typeof updates.isPrimaryVersion === "boolean"
        ? updates.isPrimaryVersion
        : Boolean(post.isPrimaryVersion),
    isArchive:
      typeof updates.isArchive === "boolean"
        ? updates.isArchive
        : Boolean(post.isArchive),
    isHomepageEligible:
      typeof updates.isHomepageEligible === "boolean"
        ? updates.isHomepageEligible
        : Boolean(post.isHomepageEligible),
    versionFamily:
      typeof updates.versionFamily === "string"
        ? updates.versionFamily
        : String(post.versionFamily || "")
  };
}
...
function applyCurationToPosts(posts = []) {
  ...
  let nextPosts = posts.map((post) =>
    updatePost(post, {
      isPrimaryVersion:
        typeof post.isPrimaryVersion === "boolean"
          ? post.isPrimaryVersion
          : false,
      isArchive: typeof post.isArchive === "boolean" ? post.isArchive : false,
      isHomepageEligible:
        typeof post.isHomepageEligible === "boolean"
          ? post.isHomepageEligible
          : false,
      versionFamily:
        typeof post.versionFamily === "string" ? post.versionFamily : ""
    })
  );
  ...
  CURATION_MAP.forEach((entry) => {
    ...
    familyMembers.forEach((member) => {
      ...
      const shouldApplyLeaderValues =
        isLeader &&
        (entry.set.isPrimaryVersion ||
          entry.set.isHomepageEligible ||
          !familyMembers.some((post) => !isDonnaPost(post)));
  ...
  nextPosts = nextPosts.map((post) => {
    ...
    const familyHasExplicitNonDonnaLeader = nextPosts.some(
      (entry) =>
        entry.versionFamily === familyKey &&
        familyKey &&
        !isDonnaPost(entry) &&
        explicitProtectedSlugs.has(entry.slug)
    );

    if (
      familyHasExplicitNonDonnaLeader ||
      !familyKey ||
      !explicitProtectedSlugs.has(post.slug)
    ) {
      return updatePost(post, {
        isArchive: true,
        isHomepageEligible: false,
        isPrimaryVersion: familyHasExplicitNonDonnaLeader
          ? false
          : post.isPrimaryVersion
      });
    }
  ...
  homepageLeaderByFamily.forEach((familyPosts, familyKey) => {
    ...
    nextPosts = nextPosts.map((post) => {
      ...
      return updatePost(post, {
        ...
        isPrimaryVersion:
          leader && post.slug === leader.slug ? post.isPrimaryVersion : false
      });
    });
  });
  ...
  const summary = {
    ...
    homepageEligibleTrue: nextPosts.filter((post) => post.isHomepageEligible)
      .length,
    versionFamilyAssigned: nextPosts.filter((post) =>
      String(post.versionFamily || "").trim()
    ).length
  };
...
async function main() {
  ...
  const result = applyCurationToPosts(
